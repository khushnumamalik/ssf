...
$(".bg-overlay").click(function () {
 ...
 const contentData = {
      ...
      vision: `We envision a world where individuals recognize the harmony between scientific knowledge and spiritual wisdom, unlocking a life of limitless possibilities.

By fostering a deeper understanding of the self and the universe, we aspire to guide humanity towards collective growth, conscious living, and a more meaningful existence.`,

      values: ` <b>Empowerment:</b> We believe in the inherent power within every individual and strive to nurture it through our teachings and guidance. </br>
<b>Balance: </b> We uphold the balance between science and spirituality, recognizing the importance of both in leading a purposeful life. </br>
<b>Growth:  </b> Continuous personal growth and self-discovery are at the core of our approach.`
    };
